...
<body>
    ...
    <div class="container text-center">
        <h3 class="text-danger"><b>@isset($message)
            {{ $message }}
            @endif
        </b></h3>
        <br>
        <form method="post" action="/ispis">
            @csrf
            <div class="form-group pl-5 pr-5">
                <label for="br">Broj karte clana(ID):</label>
                <input type="number" class="form-control" id="br" name="br">
            </div>
            <div class="form-group text-center">
              <button type="submit" class="btn btn-primary text-center">Pronadji</button>
            </div>
        </form>
    </div>
    <br>
